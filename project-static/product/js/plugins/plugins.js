...
!function () {
    ...
    t.prototype = {
        init: function () {
            ...
            var t = this;
            t.diff = (t.loaded / 100 * Math.PI * 2 * 10).toFixed(2), t.context.clearRect(0, 0, t.width, t.height), t.context.lineWidth = 5, t.context.fillStyle = "#000", t.context.strokeStyle = "#ffaf02", t.context.textAlign = "center", t.context.fillText(t.loaded + "%", .5 * t.width, .5 * t.height + 2, t.width), t.context.beginPath(), t.context.arc(35, 35, 30, t.start, t.diff / 10 + t.start, !1), t.context.stroke(), t.loaded >= t.total && clearInterval(t.timer), t.loaded++
        }
    };
    var e = function (t) {
