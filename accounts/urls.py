...
urlpatterns = [
    ...
    path('profile', UserUpdateProfileView.as_view(), name='update_profile'),
    path('kyc', UserUpdateKYCView.as_view(), name='update_kyc'),
    path('phone', UserUpdatePhoneView.as_view(), name='update_phone'),
    path('phone/verify', UserUpdatePhoneView.as_view(),
         name='update_phone_verify'),
