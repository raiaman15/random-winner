    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, help_text='The amount in INR to be added (Taxes will be added on this amount)', max_digits=7, validators=[config.validators.validate_amount])),
                ('tax', models.DecimalField(decimal_places=2, max_digits=7, validators=[config.validators.validate_amount])),
