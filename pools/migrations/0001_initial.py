    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investment', models.DecimalField(decimal_places=2, default=10000, editable=False, max_digits=7, validators=[pools.validators.validate_investment])),
                ('master', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='master', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='PoolMember',
        ...
        migrations.AddField(
            model_name='pool',
            name='members',
            field=models.ManyToManyField(blank=True, related_name='member', through='pools.PoolMember', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
