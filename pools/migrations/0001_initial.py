    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.IntegerField(default=20, help_text='Pool size, i.e. maximum member count for the Pool', validators=[config.validators.validate_number, config.validators.validate_pool_size], verbose_name='Pool Size')),
