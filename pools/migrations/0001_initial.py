    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codename', models.CharField(editable=False, help_text='Codename for the Pool', max_length=250, unique=True)),
                ('name', models.CharField(editable=False, help_text='Name for the Pool', max_length=250, validators=[config.validators.validate_name])),
                ('size', models.IntegerField(default=20, help_text='Pool size, i.e. maximum member count for the Pool', validators=[config.validators.validate_number])),
