# Generated by Django 3.1.5 on 2021-02-05 00:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_of_transaction', models.CharField(choices=[('D', 'Debit'), ('C', 'Credit')], max_length=1, validators=[config.validators.validate_balance_transaction_type])),
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='balance_transaction', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
